<template>
  <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
    ...
    <div class="card-container">
      <div class="card text-dark card-has-bg">
        <div class="card-front" :style="'background-image: url(' + faction.picture + ');'">
          <img class="card-img d-none" :src="faction.picture" alt="Card Image">
